          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-left border-collapse">
              <thead className="bg-gray-50 dark:bg-[#161b22] text-gray-700 dark:text-gray-300 border-y border-gray-200 dark:border-gray-800">
                <tr>
                  <th className="py-3 px-4 font-semibold w-1/4">Component</th>
                  <th className="py-3 px-4 font-semibold w-1/2">Description</th>
                  <th className="py-3 px-4 font-semibold w-1/4">Props</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200 dark:divide-gray-800 text-gray-800 dark:text-gray-300">
                <tr className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                  <td className="py-4 px-4 font-mono text-purple-600 dark:text-purple-400">&lt;WindowSystemProvider /&gt;</td>
                  <td className="py-4 px-4 leading-relaxed">Context provider required for the window system. Wrap your app with this.</td>
                  <td className="py-4 px-4 font-mono text-xs text-blue-600 dark:text-blue-400">children: ReactNode</td>
                </tr>
                <tr className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                  <td className="py-4 px-4 font-mono text-purple-600 dark:text-purple-400">&lt;WindowManager /&gt;</td>
                  <td className="py-4 px-4 leading-relaxed">Renders active windows and snap overlays. Must be inside the provider.</td>
                  <td className="py-4 px-4 italic text-gray-500">None</td>
                </tr>
                <tr className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                  <td className="py-4 px-4 font-mono text-purple-600 dark:text-purple-400">&lt;Toolbar /&gt;</td>
                  <td className="py-4 px-4 leading-relaxed">Renders the taskbar with app launchers and manages minimized windows.</td>
              ...
              <div className="overflow-x-auto rounded-xl border border-gray-200 dark:border-[#30363d] shadow-sm">
                <table className="w-full text-sm text-left border-collapse">
                  <thead className="bg-gray-50 dark:bg-[#161b22] text-gray-700 dark:text-gray-300">
                    <tr>
                      <th className="py-3 px-4 font-semibold w-1/4">Property</th>
                  ...
                  <tbody className="divide-y divide-gray-200 dark:divide-gray-800 text-gray-800 dark:text-gray-300 bg-white dark:bg-[#0d1117]">
                    <tr>
                      <td className="py-3 px-4 font-mono font-medium">id</td>
                      <td className="py-3 px-4 font-mono text-xs text-purple-600 dark:text-purple-400">string</td>
                      <td className="py-3 px-4 leading-relaxed"><strong>Required.</strong> Unique identifier for the window instance.</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 font-mono font-medium">title</td>
                      <td className="py-3 px-4 font-mono text-xs text-purple-600 dark:text-purple-400">string</td>
                      <td className="py-3 px-4 leading-relaxed"><strong>Required.</strong> Text displayed in the window header.</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 font-mono font-medium">component</td>
                      <td className="py-3 px-4 font-mono text-xs text-purple-600 dark:text-purple-400">React.ReactNode</td>
                      <td className="py-3 px-4 leading-relaxed"><strong>Required.</strong> The view to be rendered inside the window.</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 font-mono font-medium">icon</td>
                      <td className="py-3 px-4 font-mono text-xs text-purple-600 dark:text-purple-400">React.ReactNode</td>
                      <td className="py-3 px-4 leading-relaxed">Optional element (e.g., SVG/image) for headers/toolbars.</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 font-mono font-medium">initialSize</td>
                      <td className="py-3 px-4 font-mono text-xs text-purple-600 dark:text-purple-400">{'{'} width: number; height: number {'}'}</td>
                      <td className="py-3 px-4 leading-relaxed">Optional starting dimensions.</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 font-mono font-medium">initialPosition</td>
                      <td className="py-3 px-4 font-mono text-xs text-purple-600 dark:text-purple-400">{'{'} x: number; y: number {'}'}</td>
                      <td className="py-3 px-4 leading-relaxed">Optional starting coordinates.</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 font-mono font-medium">layer</td>
                      <td className="py-3 px-4 font-mono text-xs text-purple-600 dark:text-purple-400">'base' | 'normal' | 'alwaysOnTop' | 'modal'</td>
                      <td className="py-3 px-4 leading-relaxed">Window render priority layer.</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 font-mono font-medium">isMaximized</td>
                      <td className="py-3 px-4 font-mono text-xs text-purple-600 dark:text-purple-400">boolean</td>
                      <td className="py-3 px-4 leading-relaxed">If true, spawns the window spanning the screen.</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 font-mono font-medium">canMinimize</td>
                      <td className="py-3 px-4 font-mono text-xs text-purple-600 dark:text-purple-400">boolean</td>
                      <td className="py-3 px-4 leading-relaxed">Allows the user to hide the window.</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 font-mono font-medium">canMaximize</td>
                      <td className="py-3 px-4 font-mono text-xs text-purple-600 dark:text-purple-400">boolean</td>
                      <td className="py-3 px-4 leading-relaxed">Allows the user to toggle screen-spanning.</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 font-mono font-medium">canClose</td>
                      <td className="py-3 px-4 font-mono text-xs text-purple-600 dark:text-purple-400">boolean</td>
                      <td className="py-3 px-4 leading-relaxed">Allows the user to destroy the window.</td>
                    </tr>
                  </tbody>
                </table>
              </div>
                ...
                <table className="w-full text-sm text-left border-collapse">
                  ...
                  <tbody className="divide-y divide-gray-200 dark:divide-gray-800 text-gray-800 dark:text-gray-300 bg-white dark:bg-[#0d1117]">
                    <tr>
                      <td className="py-3 px-4 font-mono font-medium">id</td>
                      <td className="py-3 px-4 font-mono text-xs text-purple-600 dark:text-purple-400">string</td>
                      <td className="py-3 px-4 leading-relaxed"><strong>Required.</strong> Unique identifier for the folder.</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 font-mono font-medium">title</td>
                      <td className="py-3 px-4 font-mono text-xs text-purple-600 dark:text-purple-400">string</td>
                      <td className="py-3 px-4 leading-relaxed"><strong>Required.</strong> Folder name.</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 font-mono font-medium">apps</td>
                      <td className="py-3 px-4 font-mono text-xs text-purple-600 dark:text-purple-400">WindowDefinition[]</td>
                      <td className="py-3 px-4 leading-relaxed"><strong>Required.</strong> Array of windows contained within.</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 font-mono font-medium">icon</td>
                      <td className="py-3 px-4 font-mono text-xs text-purple-600 dark:text-purple-400">React.ReactNode</td>
                      <td className="py-3 px-4 leading-relaxed">Optional visual descriptor.</td>
                    </tr>
                  </tbody>
                </table>
              </div>
