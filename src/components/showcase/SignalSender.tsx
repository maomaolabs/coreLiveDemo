  ...
  return (
    <div className="w-full h-full bg-neutral-950 p-6 flex flex-col justify-center items-center">
      <div className="mb-6 text-center">
        ...
        <h2 className="text-2xl font-bold text-white mb-2">Transmitter Node</h2>
      ...
      <div className="w-full max-w-sm space-y-4">
        <div>
          <label className="block text-xs font-mono text-neutral-500 uppercase tracking-widest mb-2 ml-1">Live Payload</label>
          <input
            type="text"
            value={signal}
            onChange={(e) => emit(e.target.value)}
            className="w-full bg-neutral-900 border border-neutral-700/50 rounded-xl px-5 py-4 text-white text-lg font-medium focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all shadow-inner placeholder:text-neutral-700"
