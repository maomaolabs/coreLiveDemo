  ...
  return (
    <div className="w-full h-full bg-neutral-950 p-6 flex flex-col justify-center items-center">
      <div className="mb-6 text-center">
        <div className={`inline-flex items-center justify-center w-16 h-16 rounded-full mb-4 transition-colors duration-300 ${signal.length > 0 ? "bg-emerald-500/20 text-emerald-400 shadow-[0_0_20px_rgba(16,185,129,0.3)]" : "bg-neutral-800 text-neutral-500"
          }`}>
          <RadioReceiver size={32} className={signal.length > 0 ? "animate-pulse" : ""} />
        </div>
        <h2 className="text-2xl font-bold text-white mb-2">Receiver Array</h2>
